...
public:
	...
	bool SendMsg(UINT32 sessionIndex, UINT32 dataSize, const char* pData)	{ return GetClientInfo(sessionIndex)->SendMsg(dataSize, pData); }
...
protected:
	...
	virtual void OnReceive(UINT32 clientIndex, UINT32 size, const char* pData_) = 0;
